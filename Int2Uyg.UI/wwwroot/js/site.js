...
if (token == null) {
    ...
    // NOT: Buradaki localhost portunu kendi API portunla değiştirmeyi unutma!
    $("#ImgUserPhoto").attr("src", "https://localhost:7258/Files/UserPhotos/" + userPhoto);
...
// Token'ın içindeki şifreli veriyi çözen efsane fonksiyon
